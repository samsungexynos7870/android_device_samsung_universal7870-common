...
#define CMDLINE_PARSER_VERSION "2.10"
#endif
...
struct gengetopt_args_info
{
  ...
  char * wait_orig;	/**< @brief timeout value (msec) for pinevent original value given at command line.  */
  const char *wait_help; /**< @brief timeout value (msec) for pinevent help description.  */
