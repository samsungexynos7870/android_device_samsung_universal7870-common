/*
  ...
  gengetopt -i app/climax/src/cli/climax_cmdline.ggo --output-dir=./app/climax/src/cli
...
init_help_array(void)
{
  ...
  gengetopt_args_info_help[22] = gengetopt_args_info_full_help[27];
  gengetopt_args_info_help[23] = gengetopt_args_info_full_help[28];
  ...
  gengetopt_args_info_help[49] = 0;

}

const char *gengetopt_args_info_help[50];
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->save_help = gengetopt_args_info_full_help[17] ;
  args_info->currentprof_help = gengetopt_args_info_full_help[19] ;
  args_info->versions_help = gengetopt_args_info_full_help[20] ;
  args_info->register_help = gengetopt_args_info_full_help[21] ;
  args_info->register_min = 0;
  args_info->register_max = 0;
  args_info->regwrite_help = gengetopt_args_info_full_help[22] ;
  args_info->regwrite_min = 0;
  args_info->regwrite_max = 0;
  args_info->vstepmsg_help = gengetopt_args_info_full_help[23] ;
  args_info->dump_help = gengetopt_args_info_full_help[24] ;
  args_info->pin_help = gengetopt_args_info_full_help[25] ;
  args_info->wait_help = gengetopt_args_info_full_help[26] ;
  ...
  args_info->ymem_help = gengetopt_args_info_full_help[29] ;
  args_info->ymem_min = 0;
  args_info->ymem_max = 0;
  args_info->pmem_help = gengetopt_args_info_full_help[30] ;
  args_info->pmem_min = 0;
  args_info->pmem_max = 0;
  args_info->iomem_help = gengetopt_args_info_full_help[31] ;
  args_info->iomem_min = 0;
  args_info->iomem_max = 0;
  args_info->speaker_help = gengetopt_args_info_full_help[32] ;
  args_info->dumpmodel_help = gengetopt_args_info_full_help[34] ;
  args_info->record_help = gengetopt_args_info_full_help[35] ;
  args_info->count_help = gengetopt_args_info_full_help[36] ;
  args_info->output_help = gengetopt_args_info_full_help[37] ;
  args_info->logger_help = gengetopt_args_info_full_help[38] ;
  args_info->ini2cnt_help = gengetopt_args_info_full_help[40] ;
  args_info->bin2hdr_help = gengetopt_args_info_full_help[41] ;
  args_info->tfa_help = gengetopt_args_info_full_help[42] ;
  args_info->load_help = gengetopt_args_info_full_help[44] ;
  args_info->splitparms_help = gengetopt_args_info_full_help[45] ;
  ...
  args_info->monitor_help = gengetopt_args_info_full_help[51] ;
  args_info->trace_help = gengetopt_args_info_full_help[52] ;
  args_info->rpc_help = gengetopt_args_info_full_help[53] ;
			...
			struct cmdline_parser_params *params, const char *additional_error)
{
  ...
  for(;;)
	...
	case 0:	/* Long option with no short option */
	  ...
	  /* timeout value (msec) to wait for pinevent.  */
